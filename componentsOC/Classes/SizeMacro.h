...
#define kHomeCycleScrollHeight 175.0f
...
#define kSearchVedioContentCollectionSize CGSizeMake((kScreenWidth-30)/2, 115*kHeightRate+30)
#define kSearchSectionTitleCellHeight 45.0f

#define kFindBottomSpace         14.0f //下边距
#define kFindHeadImgWidth        50.0f //头像宽度  / 播放按钮
#define kFindVedioImgHeight      215*kHeightRate //视屏图片高度
...
#define kAnchorHeadViewHeight    225.0f
